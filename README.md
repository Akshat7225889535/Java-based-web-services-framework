...
You can use this framework to create backend/serverside services for web requests, Now user no need worry  about servlets or edit Web.xml,user can simply use the framework and all  need can be solved.
